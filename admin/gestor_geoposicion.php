  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      $(document).on("click", ".btnVer", function(){
        ...
        let accion = "trerDetalleVehiculo";
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $detalleVehiculo = `<div class="row">
                <div class="col-lg-3">
                  <div class="form-group">
                     <label class="col-form-label font-weight-bold">Patente:</label><br>${datos.datos_vehiculo.patente}
                  </div>
                </div>
                <div class="col-lg-3">
                  <div class="form-group">
                     <label class="col-form-label font-weight-bold">Marca:</label><br>${datos.datos_vehiculo.marca}
                  </div>
                </div>
                <div class="col-lg-3">
                  <div class="form-group">
                     <label class="col-form-label font-weight-bold">Modelo:</label><br>${datos.datos_vehiculo.modelo}
                  </div>
                </div>
                <div class="col-lg-3">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">Año:</label><br>${datos.datos_vehiculo.anio}
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-4">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">Codigo motor:</label><br>${datos.datos_vehiculo.codigo_motor}
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">Codigo chasis:</label><br>${datos.datos_vehiculo.codigo_chasis}
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">N° cedula verde:</label><br>${datos.datos_vehiculo.nro_cedula_verde}
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-4">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">Tecnico asignado:</label><br>${datos.datos_vehiculo.tecnico}
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">KM adquirido:</label><br>${datos.datos_vehiculo.km_adquirido_mostrar}
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">KM actuales:</label><br>${datos.datos_vehiculo.km_actuales_mostrar}
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-3">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">Fecha adquirido:</label><br>${datos.datos_vehiculo.fecha_adquirido_mostrar}
                  </div>
                </div>
                <div class="col-lg-3">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">Proximo service general:</label><br>${datos.datos_vehiculo.proximo_service_general_mostrar}
                  </div>
                </div>
                <div class="col-lg-3">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">Proximo vencimiento VTV:</label><br>${datos.datos_vehiculo.proximo_vencimiento_vtv_mostrar}
                  </div>
                </div>
                <div class="col-lg-3">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">Fecha de baja:</label><br>${datos.datos_vehiculo.fecha_baja_mostrar}
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    <label class="col-form-label font-weight-bold">Comentarios:</label><br>${datos.datos_vehiculo.comentarios}
                  </div>
                </div>
              </div>
