...
<html lang="en">
  ...
  <body>
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <span id="id_cargo" class="d-none"></span>
              ...
              <form id="formCargos">    
                  <div class="modal-body">
                      <div class="row">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              <label for="" class="col-form-label">Sindicato:</label>
                              <select class="form-control" id="id_sindicato">
    ...
    function cargarDatosComponentes(){
                ...
                $.ajax({
                    ...
                    success: function(respuesta){
                        ...
                        /*Identifico el select de sindicato*/
                        $selectSindicatos = document.getElementById("id_sindicato");

                        
                        /*Convierto en json la respuesta del servidor*/
                        respuestaJson = JSON.parse(respuesta);

                        /*Genero los options del select sindicato*/
                        respuestaJson.sindicatos.forEach((sindicatos)=>{
                            $option = document.createElement("option");
                            let optionText = document.createTextNode(sindicatos.sindicato);
                            $option.appendChild(optionText);
                            $option.setAttribute("value", sindicatos.id_sindicato);
                            $selectSindicatos.appendChild($option);
                        })
    ...
    $(document).on("click", ".btnEditar", function(){
      ...
      let id_cargo = fila.find('td:eq(0)').text();    

      let datosUpdate = new FormData();
      datosUpdate.append('accion', 'traerCargoUpdate');
      ...
      $.ajax({
            ...
            success: function(datosProcesados){
              ...
              $("#cargo").val(datosInput[0].cargo);
              
              if(datosInput[0].id_sindicato == 0){
                id_sindicato = ""
              }else{
                id_sindicato = datosInput[0].id_sindicato;
              }

              $("#id_sindicato").val(id_sindicato);
              $('#id_cargo').html(datosInput[0].id_cargo);
              accion = "updateCargo";
            }
          });
    ...
    let id_sindicato = $.trim($('#id_sindicato').val());
    let id_sindicato_enviar = 0;
    if(id_sindicato != ""){
      id_sindicato_enviar = id_sindicato;
    }
    let id_cargo = $.trim($('#id_cargo').html());                
        $.ajax({
          url: "models/administrar_cargos.php",
          type: "POST",
          datatype:"json",    
          data:  {accion: accion, id_cargo:id_cargo, cargo:cargo, id_sindicato:id_sindicato_enviar},    
    ...
    $(".modal-header").css( "color", "white" );
    $(".modal-title").text("Alta de cargos");
    $('#modalCRUD').modal('show');      
});
...
$(document).on("click", ".btnBorrar", function(){
    fila = $(this);           
    let id_cargo = parseInt($(this).closest('tr').find('td:eq(0)').text());       
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                                ...
                                type: "POST",
                                datatype:"json",    
                                data:  {accion:accion, id_cargo:id_cargo},    
                                success: function() {
