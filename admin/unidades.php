  ...
  <body>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-hover" id="tablaUmedidas">
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <span id="id_uMedida" class="d-none"></span>
                      ...
                      <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="uMedida" required>
                            </div>
                          </div>   
                      </div>              
                  </div>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
       tablaUmedidas= $('#tablaUmedidas').DataTable({
            "ajax": {
    ...
    function cargarDatosComponentes(){
                ...
                $.ajax({
                    data: datosIniciales,
                    url: "./models/administrar_unidades.php",
                    method: "post",
                    cache: false,
                    contentType: false,
                    processData: false,
    ...
    $(document).on("click", ".btnEditar", function(){
      ...
      let id_uMedida = fila.find('td:eq(0)').text();    

      let datosUpdate = new FormData();
      datosUpdate.append('accion', 'traerUMedidaUpdate');
      datosUpdate.append('id_uMedida', id_uMedida);
      $.ajax({
            data: datosUpdate,
            url: './models/administrar_unidades.php',
            method: "post",
    ...
    $('#formUmedida').submit(function(e){                         
    e.preventDefault(); //evita el comportambiento normal del submit, es decir, recarga total de la página   
    uMedida = $.trim($('#uMedida').val());    
    
    id_uMedida = $.trim($('#id_uMedida').html());                
        $.ajax({
          url: "models/administrar_unidades.php",
          type: "POST",
          datatype:"json",    
          data:  {accion: accion,id_uMedida:id_uMedida, uMedida:uMedida},    
          success: function(data) {
            tablaUmedidas.ajax.reload(null, false);
           }
        });             
    ...
    $("#btnNuevo").click(function(){
      accion = "addUMedida";
    $("#formUmedida").trigger("reset");
    $(".modal-header").css( "background-color", "#17a2b8");
    $(".modal-header").css( "color", "white" );
    $(".modal-title").text("Alta de unidad de medida");
    $('#modalCRUD').modal('show');      
});
...
$(document).on("click", ".btnBorrar", function(){
    fila = $(this);           
    id_uMedida = parseInt($(this).closest('tr').find('td:eq(0)').text());       
    ...
    swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        accion = "eliminarUMedida";
                        $.ajax({
                                url: "models/administrar_unidades.php",
                                type: "POST",
                                datatype:"json",    
                                data:  {accion:accion, id_uMedida:id_uMedida},    
                                success: function() {
                                    tablaUmedidas.row(fila.parents('tr')).remove().draw();                  
                                }
                            }); 
                    } else {
